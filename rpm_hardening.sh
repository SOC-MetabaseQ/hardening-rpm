...
systemctl list-unit-files "avahi-daemon.service" | grep -q 1 && systemctl disable avahi-daemon || :
...
systemctl list-unit-files "cups.service" | grep -q 1 && systemctl disable cups || :
policystatus=$?
if [[ "$policystatus" -eq 0 ]]; then
...
systemctl list-unit-files "dhcpd.service" | grep -q 1 && systemctl disable dhcpd || :
policystatus=$?
if [[ "$policystatus" -eq 0 ]]; then
...
systemctl list-unit-files "slapd.service" | grep -q 1 && systemctl disable slapd || :
policystatus=$?
if [[ "$policystatus" -eq 0 ]]; then
...
systemctl list-unit-files "nfs.service" | grep -q 1 && $(systemctl disable nfs && systemctl disable nfs-server && systemctl disable rpcbind) || :
...
systemctl list-unit-files "named.service" | grep -q 1 && systemctl disable named || :
policystatus=$?
if [[ "$policystatus" -eq 0 ]]; then
...
systemctl list-unit-files "vsftpd.service" | grep -q 1 && systemctl disable named || :
policystatus=$?
if [[ "$policystatus" -eq 0 ]]; then
...
systemctl list-unit-files "httpd.service" | grep -q 1 && systemctl disable httpd || :
policystatus=$?
if [[ "$policystatus" -eq 0 ]]; then
...
systemctl list-unit-files "dovecot.service" | grep -q 1 && systemctl disable httpd || :
policystatus=$?
if [[ "$policystatus" -eq 0 ]]; then
...
systemctl list-unit-files "smb.service" | grep -q 1 && systemctl disable smb || :
policystatus=$?
if [[ "$policystatus" -eq 0 ]]; then
...
systemctl list-unit-files "squid.service" | grep -q 1 && systemctl disable squid || :
...
systemctl list-unit-files "snmpd.service" | grep -q 1 && systemctl disable snmpd || :
policystatus=$?
if [[ "$policystatus" -eq 0 ]]; then
...
systemctl list-unit-files "ypserv.service" | grep -q 1 && systemctl disable ypserv || :
policystatus=$?
if [[ "$policystatus" -eq 0 ]]; then
...
systemctl list-unit-files "rsh.socket.service" | grep -q 1 && $(systemctl disable rsh.socket.service && systemctl disable rlogin.socket.service && systemctl disable rexec.socket.service) || :
policystatus=$?
if [[ "$policystatus" -eq 0 ]]; then
...
systemctl list-unit-files "telnet.socket.service" | grep -q 1 && systemctl disable telnet.socket.service || :
policystatus=$?
if [[ "$policystatus" -eq 0 ]]; then
...
systemctl list-unit-files "tftp.socket.service" | grep -q 1 && systemctl disable tftp.socket || :
policystatus=$?
if [[ "$policystatus" -eq 0 ]]; then
...
systemctl list-unit-files "rsyncd.service" | grep -q 1 && systemctl disable rsyncd || :
policystatus=$?
if [[ "$policystatus" -eq 0 ]]; then
...
systemctl list-unit-files "ntalk.service" | grep -q 1 && systemctl disable ntalk || :
policystatus=$?
if [[ "$policystatus" -eq 0 ]]; then
...
yum install -y iptables && policystatus=$?
policystatus=$?
if [[ "$policystatus" -eq 0 ]]; then
...
yum install -y rsyslog #&& yum install syslog-ng
policystatus=$?
if [[ "$policystatus" -eq 0 ]]; then
